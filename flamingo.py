# /mlx_devbox/users/cheng.cwang/playground/datasets/flamingo.py
...
def respond(audio_path, input_text):
    return predict(audio_path, input_text, clap_config, inference_kwargs)


# --- Global Initialization (transplanted from __main__ block) ---
snapshot_download(repo_id="nvidia/audio-flamingo-2", local_dir="./", token="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")
...
# Load metadata and reconstruct the full state_dict
...
respond("/mlx_devbox/users/cheng.cwang/playground/datasets/VSC/audio/f0008_0_laughter.wav", "Describe the audio")
